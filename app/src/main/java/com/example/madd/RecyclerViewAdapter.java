...
import com.example.madd.contac;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>
{
    ...
    //Context mContext;
    private ArrayList<contac> mData;

    public RecyclerViewAdapter(ArrayList<contac> Data)
    {
        this.mData = Data;
    }
    ...
    {
        View v;
        v= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_contac,parent,false);
